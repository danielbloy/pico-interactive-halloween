...
Also, as I've learnt more about what works and what doesn't, I'm designing all-new control
...
* [x] Undertake a full inventory of devices.
* [x] Design and manufacture new eyes.
* [x] Design and manufacture skull holders.
...
* [x] Finish the design of the skull mount.
* [x] Manufacture the skull mounts.
* [x] Review the sounds that are played.
...
for an additional effect. One more sound box will be installed to provide
...
* Smoke machine.
* Lightning box.
* Raspberry Pi background sound box.
...
* [x] Construct robust mounts for gravestones.
* [x] Select sounds.
* [x] Build Raspberry Pi Graveyard audio box.
...
* [x] Review the videos to display and timings.
...
Within the `microcontroller/makecode_arcade/eyes` directory are some images
...
* [x] Carve pumpkins and install tea lights.
...
* [x] Purchase new gazebo.
* [x] Review the witches sounds.
