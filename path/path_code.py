...
from interactive.configuration import PRIMARY_NODE, TRIGGER_PIN
from interactive.configuration import SKULL_PINS, SKULL_BRIGHTNESS, SKULL_COLOUR, SKULL_SPEED
